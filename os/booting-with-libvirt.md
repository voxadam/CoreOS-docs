...
```sh
mkdir /var/lib/libvirt/images/coreos/coreos1/configdrive
semanage fcontext -a -t virt_content_t "/var/lib/libvirt/images/coreos1/configdrive(/.*)?"
restorecon -R "/var/lib/libvirt/images/coreos/coreos1/configdrive"
```
